...
Revision ID: 563ee847540b
Revises: 
Create Date: 2022-06-05 10:48:02.792138
...
def upgrade():
    ...
    sa.Column('available_dates', sa.ARRAY(sa.DateTime(timezone=True)), nullable=True),
